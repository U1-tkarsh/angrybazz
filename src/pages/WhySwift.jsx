...
function WhySwifts() {
  ...
  return (
    <div>
      ...
      <div className="max-w-8xl text-white bg-blue-900 lg:bg-gray-300 lg:p-10 relative">
        <div className="p-2"><Link to="/">Home / Why Swift Transport</Link></div>
        <div className="bg-blue-900 rounded-2xl pb-28 relative">
          <div className="text-white px-4 sm:px-16 pt-8 sm:pt-10 font-bold text-xl sm:text-2xl underline">
           Why Swift Transport
          </div>
          <div className="grid grid-cols-2 pr-20 md:px-28 lg:hidden gap-4 ">
            <div className="bg-red-600 w-36 h-36 md:h-48 md:w-48 ml-10 lg:ml-0 m-10 lg:w-80 lg:h-52 z-50">
              <div className="text-center ">
                <div className="p-3 md:p-8">
                  <FindInPageOutlinedIcon style={{ fontSize: 80 }} />
                </div>
                <div className="text-2xl">Case Study</div>
              </div>
            </div>
            <div className="bg-red-600 md:h-48 md:w-48 w-36 m-10 h-36 ">
              <div className="text-center">
                <div className="p-3 md:p-8">
                  <ThumbUpAltOutlinedIcon style={{ fontSize: 80 }} />
                </div>
              </div>
              <div className="text-2xl text-center">Testimonials</div>
            </div>
          </div>
          <div className="text-white px-4 sm:px-16 text-lg sm:text-xl font-bold p-2 sm:p-5">
            Here from our loyal customers about why{" "}
            <div>they're happy to recommend us to you.</div>
          </div>

          <div className="text-white px-4 sm:px-16 pb-8 sm:pb-14 p-2 sm:p-5">
          ...
          <div className="absolute bg-gray-400 bottom-4 sm:bottom-8 left-4 sm:left-16 py-2 sm:py-4 px-4 sm:px-16 rounded-2xl text-blue-900 font-bold">
            Learn More
          </div>
        </div>
        <div className="grid grid-cols-2 gap-4 md:grid-cols-1">
          <div className="bg-red-600 h-36 sm:w-36 md:h-0 lg:h-52 ml-4 sm:ml-0 lg:w-80 absolute top-12 lg:top-28 sm:right-28 z-50"></div>
          <div className="bg-red-600 h-52 sm:w-36 md:h-0 lg:h-52 lg:w-80 absolute bottom-8 sm:bottom-20 right-4 sm:right-28 z-50"></div>
        </div>
      </div>

      {/* Why Swift */}
      <div className="bg-red-900 px-4 py-8 relative lg:px-8 max-w-8xl">
        <div className="bg-white">
          ...
          <div className="text-blue-900 pt-8 pb-4 px-4 lg:px-10 font-bold text-xl lg:text-2xl">
            Why Swift
          </div>
          <div>
            {visibleParas.map((para) => (
              <div className="px-4 lg:px-10 py-4 lg:py-6" key={para.id}>
                {para.para}
              </div>
            ))}
            <div className="px-4 lg:px-10 py-4 lg:py-6 flex justify-center">
              {renderCarouselIcons()}
            </div>
          </div>
        </div>

        <div className="absolute invisible lg:visible h-full w-1/2 pl-8 pt-8 bottom-0 right-0">
          <img
            src="https://media.istockphoto.com/id/466104101/photo/fast-transport.webp?b=1&s=170667a&w=0&k=20&c=mZd-UTgnDVDTfFdL8aFRCdUc3Z7TUMHwqeypbBdBy7I="
            alt=""
            srcSet=""
      ...
      {/* Case Studies */}
      <div className="max-w-8xl mx-auto mt-5 pb-12 bg-blue-900">
      ...
      {/* Testimonials */}
      <div className="max-w-8xl mb-10 bg-white shadow-xl">
        <div className="text-blue-900 px-5 py-3 md:px-24 md:py-5 text-2xl font-bold">
          Testimonials
        </div>
        <div className="md:p-2 lg:p-10">
          <div className="flex">
            <button
              onClick={prevTest}
            ...
            {visibleTest.map((test) => (
              <div className="flex flex-col md:flex-row items-center">
                <img
                  className="w-full h-auto md:w-52 md:h-48 lg:w-64 lg:h-56"
                  src={test.link}
                  alt=""
                />
                <div className="pl-2 md:pl-12">{test.desc}</div>
              </div>
            ))}
            <button
              onClick={nextTest}
          ...
          <div className="mx-10 flex my-10 pb-6 justify-center">
            {renderCarouselIcons()}
          </div>
        </div>
      </div>
