    ...
    <div className="p-6">
      ...
      <div className="max-w-8xl relative">
        <img
          ...
          srcSet=""
        />
        <div className="absolute top-8 h-80 left-4 sm:left-10 md:left-20 lg:left-32 w-11/12 sm:w-80 bg-blue-900">
          <div className="text-white font-bold text-xl sm:text-2xl py-4 px-5">
            A fleet capable of much more than you'd think
          </div>

          <div className="text-white font-light px-5 py-2 pb-10 sm:py-4">
            ...
            versatile fleet with our industry-leading technology and 'can-do'
      ...
      {/* Services */}
      <div className="bg-blue-900 py-10 lg:pl-14">
        <div className="text-white text-2xl font-bold">Services</div>

        <div className="text-xl text-white pt-4 pl-4 md:pl-6">
          A <span className="text-red-900 font-bold">smarter</span> container
          transport business
        </div>

        <div className="text-white pt-2 pl-4 md:pl-6">
          Lorem ipsum dolor sit amet, consectetur adipisicing elit. Odio ipsam
          illo cum recusandae eius repellat dolor ratione quia magnam. Animi
          libero in nemo, quasi repellat architecto dolor perferendis rerum
          sunt.
        </div>
        <div className="grid grid-cols-1 pl-0 md:pl-5 lg:pl-5 mt-6 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <Card className="w-full md:w-80 mt-6  md:px-8 mr-10">
            <CardHeader className="relative shadow-sm h-48 text-center pt-7">
              <Typography variant="h5" color="blue-gray" className="mb-2">
                Transport- Container, Tautilner, <div>Bulk</div>
              </Typography>
              <LocalShippingOutlinedIcon style={{ fontSize: 96 }} />
            </CardHeader>
            <CardBody>
              <Typography>
            ...
            <CardFooter className="pt-0">
              <div className="text-red-900 float-right cursor-pointer pr-5">
                <TrendingFlatOutlinedIcon style={{ fontSize: 72 }} />
              </div>
            </CardFooter>
          </Card>
          <Card className="w-full md:w-80 mt-6  md:px-8 mr-10">
            <CardHeader className="relative shadow-sm h-48 text-center pt-7">
              ...
              <TrainOutlinedIcon style={{ fontSize: 96 }} />
            </CardHeader>
            <CardBody>
              <Typography>
                The place is close to Barceloneta Beach and bus stop just 2 min
          ...
          <Card className="w-full md:w-80 mt-6  md:px-8 mr-10">
            <CardHeader className="relative shadow-sm h-48 text-center pt-7">
              ...
              <DepartureBoardOutlinedIcon style={{ fontSize: 96 }} />
            </CardHeader>
            <CardBody>
              <Typography>
                The place is close to Barceloneta Beach and bus stop just 2 min
          ...
          <Card className="w-full md:w-80 mt-6">
            <CardHeader className="relative shadow-sm h-48 text-center pt-7">
              <Typography variant="h5" color="blue-gray" className="mb-2">
                Warehousing - 3PL, FAK And<pre>ECommerce</pre>
              </Typography>
              <HouseOutlinedIcon style={{ fontSize: 96 }} />
            </CardHeader>
            <CardBody>
              <Typography>
                The place is close to Barceloneta Beach and bus stop just 2 min
          ...
          <Card className="mt-6 bg-red-700 text-white md:w-80">
            <CardHeader className="relative bg-red-700 text-white shadow-sm h-48 text-center pt-7">
              <Typography variant="h5" className="mb-2">
                Bio-Security & Border Security (Customers)
              </Typography>
              <SecurityOutlinedIcon style={{ fontSize: 96 }} />
            </CardHeader>
            <CardBody>
              <Typography>
                The place is close to Barceloneta Beach and bus stop just 2 min
            ...
            <CardFooter className="pt-0">
              <div className="text-white float-right cursor-pointer pr-5">
                <TrendingFlatOutlinedIcon style={{ fontSize: 72 }} />
              </div>
            </CardFooter>
          </Card>
      ...
      <div className="max-w-8xl relative rounded-lg mt-6">
        <div className="w-full">
          <img
            className="rounded-2xl w-full h-60 md:h-auto lg:h-auto"
        ...
        <div className="bg-blue-900 rounded-2xl  pb-14 pt-3 absolute top-10 w-36 md:w-80 text-white text-center">
          <p className="text-lg">Have a question regarding Swift services?</p>
          <div className="font-bold absolute left-20 md:left-48 top-22 md:top-20 lg:top-20">
      ...
      <div className="bg-red-400 relative max-w-8xl mt-6">
        <div className="text-white absolute top-4 left-4 text-xl font-bold ">
          You'll be in good company
        </div>
        <div className="relative rounded-lg flex flex-col md:flex-row p-4">
          <img
            className="mr-0 rounded-xl sm:w-full md:w-2/4 sm:p-4 md:p-8"
            ...
            srcset=""
          />
          <div className=" bg-white sm:w-full lg:w-1/2 grid grid-cols-2 p-4 gap-4">
            <div>
              <img
      ...
      <div className="max-w-8xl relative rounded-lg mt-6">
        ...
        />
        <div>
          <div className="absolute top-10 right-10 sm:right-20 text-lg font-bold text-blue-900">
            We deliver, no matter <br className="sm:hidden" />{" "}
            <span className="sm:inline">how hard the challenge</span>
          </div>
          <img
            className="absolute top-32 right-10 sm:right-20 w-40 sm:w-80"
            ...
            srcset=""
          />
          <div className="text-white underline font-bold absolute top-80 right-8 md:right-32 lg:right-20 text-xl sm:text-lg md:text-xl">
            Kennards Hire Case Study
          </div>
        </div>
      </div>

      <div className="bg-white max-w-8xl grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-5 p-6 md:p-10">
